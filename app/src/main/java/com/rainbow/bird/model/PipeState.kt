package com.rainbow.bird.model

import androidx.compose.ui.unit.Dp
import androidx.compose.ui.unit.dp
import com.rainbow.bird.utils.CommonUtil


data class PipeState (
    var offset: Dp = FirstPipeWidthOffset,
    var upHeight: Dp = CommonUtil.getRandomDp(LowPipe, HighPipe),
    ...
    fun correct(): PipeState {
        val newUpHeight = CommonUtil.getRandomDp(LowPipe, HighPipe)
        return copy(
